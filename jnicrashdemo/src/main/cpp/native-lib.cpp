...
Java_com_demo_jnicrash_MainActivity_stringFromJNI(JNIEnv *env,jobject /* this */) {
...
Java_com_demo_jnicrash_MainActivity_testNativeLeak(JNIEnv *env, jobject instance) {
    char *p;
